...
export function PendingActions({ pendingBookings }: PendingActionsProps) {
  const hasActions = pendingBookings > 0
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Bệnh nhân đã thanh toán, đang chờ được phân công bác sĩ
                  </p>
                </div>
              </div>
